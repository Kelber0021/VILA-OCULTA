# Pendências — Vila Oculta

Este arquivo registra somente itens ainda não concluídos ou que dependem de decisão/limitação externa.
...
- Definir condição matemática exata de vitória do lado dos Assassinos.
- Definir regra padrão de empate.
- Aprovar provedor/forma de hospedagem da voz após comparação técnica e de custo.
...
- Verificar se já existe projeto Supabase adequado antes de criar um novo.
